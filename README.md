...
**最新版本：v1.10.5**（2026-08-16） · [更新说明](RELEASE_NOTES.md) · [开发路线图](docs/dev-roadmap.md)
...
**v1.10.5（2026-08-16）· AI 余额与用量 + 样例修复**：设置页新增「💳 API 余额与用量」——DeepSeek/OpenAI 官方接口查询余额（手动刷新），今日调用次数与输入/输出 tokens 本地统计（所有服务商通用）；同时修复 AI 生成模板样例中货币金额（如 30,000）被误判成日期的问题。详见 [RELEASE_NOTES.md](RELEASE_NOTES.md)。
...
| 测试 | Vitest（215 项单元/集成测试）+ 端到端验证脚本 |
