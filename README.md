...
**最新版本：v1.10.7**（2026-08-21） · [更新说明](RELEASE_NOTES.md) · [开发路线图](docs/dev-roadmap.md)
...
| 测试 | Vitest（230 项单元/集成测试）+ 端到端验证脚本 |
...
| 版本 | 日期 | 重点 |
|------|------|------|
| v1.10.7 | 2026-08-21 | 支付宝归类为可展开分组 + 官方账单 CSV/GBK 解析 |
