...
**最新版本：v1.10.3**（2026-08-16） · [更新说明](RELEASE_NOTES.md) · [开发路线图](docs/dev-roadmap.md)
...
**v1.10.3（2026-08-16）· Excel 日期序列号修复**：Excel「日期格式」单元格（17/8/2026 实为序列号 46251）在银行/券商日结单导入与 AI 生成模板样例中均正确显示为真实日期。详见 [RELEASE_NOTES.md](RELEASE_NOTES.md)。
